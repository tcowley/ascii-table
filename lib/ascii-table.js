 ...
 * 
 * All config options are optional, except config.rows. 
 * 
 * A)  config.rows:
 *  
 *  1) [array, array, ...]
 ...
 *
 *   1)  ''    No border.
 *   2)  ' '   Border is whitespace between and around cells.
 *   3)  '-'   Border is single line between and around cells.
 *   Default is '-'.
 * 
 * D)  config.padding:
 *     
 *   A whole number. The number of spaces padding content inside cells. Default is 1. 
 * 
 * E)  config.margin:
 * 
 *   A whole number. The number of spaces padding to the left of the table. Default is 0. 
 * 
 * @param config     Object   {rows: rows, columns: columns, border: border, ....}
 */
